    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
				<thead>
					<tr>
						<th  style="border-left: 1px solid #C1DAD7"> First-Name </th>
						<th> Last-Name </th>
						<th> Address </th>
						<th> Contact </th>
						<th> Email </th>
					...
					while($row = mysql_fetch_array($result))
						{
							...
							echo '<td><div align="center"> | <a href="#" id="'.$row['reservation_id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
							echo '</tr>';
						}
					?> 
				</tbody>
